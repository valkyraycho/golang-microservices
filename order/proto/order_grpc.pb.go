...
const (
	OrderService_PostOrder_FullMethodName           = "/order_service.OrderService/PostOrder"
	OrderService_GetOrdersForAccount_FullMethodName = "/order_service.OrderService/GetOrdersForAccount"
)
